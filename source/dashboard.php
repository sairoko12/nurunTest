...
$usuario = Fetch::row(Connections::get()->select()->from("usuarios")->where("id_usuario = ?", $_SESSION["user"]));
...
<html lang="en">
    ...
    <body class="bg-success">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h3>Bienvenido de nuevo <strong><?php echo $usuario->username; ?></strong></h3>
                    <div class="panel panel-primary" style="margin-top: 15px;">
                        ...
                        <div class="panel-body content-tools" style="display: none;">
                            <div class="row">
                                ...
                                <div class="col-xs-2 col-xs-offset-1" style="margin-top: 23px;">
                                    <button type="button" class="btn btn-danger btn-block" onclick="location.href = 'logout.php'">Cerrar Sesión</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <h4>El contador actual es: <span id="total"><?php $cifra = Fetch::row(Connections::get()
                            ->select("id_cifra")
                            ->from("cifras")
                            ->orderBy("id_cifra", "DESC")); echo (is_object($cifra)) ? $cifra->id_cifra : ''; ?></span></h4>
                    <div class="well">
